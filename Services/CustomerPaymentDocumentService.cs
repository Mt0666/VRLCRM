...
public class CustomerPaymentDocumentService
{
    ...
    static CustomerPaymentDocumentService()
    {
        QuestPDF.Settings.License = LicenseType.Community;
    }

    public CustomerPaymentDocumentService(
    ...
    public byte[] GeneratePdf(Customer customer, IReadOnlyList<Payment> payments)
    {
                ...
                page.Content().Column(column =>
                {
                    ...
                    column.Item().Row(row =>
                    {
                        ...
                        row.ConstantItem(180).AlignRight().Column(right =>
                        {
                            ...
                            right.Item().Text(customer.FullName).FontColor(MutedColor);
                        });
                    });
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        table.Header(header =>
                        {
                            header.Cell().Background(BrandColor).Padding(6).Text("Ödeme No").FontColor(Colors.White).SemiBold();
                    ...
                    {
                        text.Span("Toplam Ödeme: ").SemiBold();
